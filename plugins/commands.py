...
async def start(client, message):
    ...
    jishubotz = await message.reply_sticker("CAACAgIAAxkBAAEBGjpmwZcRShrTlPxGIHNaRrYl7T_7ZQACVAADQbVWDGq3-McIjQH6HgQ")
    await asyncio.sleep(1)
    await jishubotz.delete()
    jishubotz = await message.reply_sticker("CAACAgQAAxkBAAEBJUdmy3HlHP5HQGT0_sSM24MupsqzSgACxhMAAmOYWFIrhIvA_kqBJh4E")
    await asyncio.sleep(1)
    await jishubotz.delete()
    # jishubotz = await message.reply_sticker("CAACAgUAAxkBAAEBJUpmy3KE83HY3jfRiSjDvPwkdJsrZAACkwcAAjkpeFSsdgX96FcxJB4E")
    # await asyncio.sleep(1)
    # await jishubotz.delete()
